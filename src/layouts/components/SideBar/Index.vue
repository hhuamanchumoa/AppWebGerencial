<template>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        ...
        <div class="sidebar-brand-text mx-3">SOLUFLEX ERP</div>
      </a>
      ...
      <!-- <li class="nav-item active">
        <a class="nav-link">
          ...
          <span>
              <router-link to="/sales">Resumen</router-link>
              </span>
        </a>
      </li> -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item"><router-link to="/sales">Ventas</router-link></a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Opciones:</h6>
            <a class="collapse-item"><router-link to="/accountsGeneral">Resumen</router-link></a>
            <a class="collapse-item"><router-link to="/accountsReceivable">Cuentas Por Cobrar</router-link></a>
            <a class="collapse-item"><router-link to="/accountsPay">Cuentas Por Pagar</router-link></a>
          </div>
        </div>
      </li>
